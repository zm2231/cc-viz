...
---
Load the cc-viz skill, then generate a comprehensive visual project recap as a self-contained HTML page.

Follow the cc-viz skill workflow. Read the reference template, CSS patterns, and mermaid theming references before generating. Use a warm editorial or paper/ink aesthetic with muted blues and greens, but vary fonts and palette from previous diagrams.
...
**Optional hero image** — consider adding an SVG hero illustration using the `.hero-img-wrap` pattern from css-patterns.md.
