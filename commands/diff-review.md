...
---
Load the cc-viz skill, then generate a comprehensive visual diff review as a self-contained HTML page.

Follow the cc-viz skill workflow. Read the reference template, CSS patterns, and mermaid theming references before generating. Use a GitHub-diff-inspired aesthetic with red/green before/after panels, but vary fonts and palette from previous diagrams.
...
**Optional illustrations** — consider adding an SVG hero banner or conceptual illustration when it would enhance the page. See css-patterns.md "Generated Images" for container styles. Skip if the diff is purely structural.
