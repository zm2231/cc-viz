...
1. **Title slide**: Use a bold CSS gradient or SVG pattern as a background to set the deck's visual tone.
2. **Full-bleed slide**: Immersive CSS background for the deck's visual anchor moment.
3. **Content slides with conceptual topics**: SVG or inline Mermaid diagram in the `.slide__aside` area.
